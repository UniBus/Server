...
gtfsInfoFile = args[0]
if not os.path.exists(gtfsInfoFile):
	print "Error: Path %s does not exist!!!" % gtfsInfoFile
	sys.exit(1) 

server.import_gtfs_info(serverHostName, serverUserName, serverDbPasswd, serverDbName, gtfsInfoFile);
